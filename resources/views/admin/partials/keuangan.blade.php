...
<div class="space-y-4 animate-up p-4 lg:p-6">
    {{-- Header --}}
    ...
    {{-- Filter Form --}}
    <form method="GET" action="{{ route('admin.keuangan.partial') }}" class="flex flex-wrap items-center gap-3 bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-gray-800 p-3.5 rounded-xl shadow-sm">
        ...
        <div class="flex flex-wrap items-center gap-2">
            <select name="fin_month" id="fin_month" onchange="this.form.requestSubmit()" class="bg-gray-50 dark:bg-[#0F172A] border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-1.5 text-xs font-bold focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none transition-all dark:text-white">
                @foreach([
            ...
            <select name="fin_year" id="fin_year" onchange="this.form.requestSubmit()" class="bg-gray-50 dark:bg-[#0F172A] border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-1.5 text-xs font-bold focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none transition-all dark:text-white">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
        <!-- KPI 1: Pendapatan -->
        <div class="kpi-card bg-gradient-to-br from-white to-gray-50/50 dark:from-[#1E293B] dark:to-[#0F172A] border border-gray-100 dark:border-gray-800 rounded-xl p-3.5 shadow-sm flex flex-col justify-between">
            <div class="flex justify-between items-start mb-1">
                ...
                <div class="p-1 rounded-lg bg-teal-500/10 text-teal-600 dark:text-teal-400">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M12 16V5"/></svg>
                </div>
            </div>
            <div>
                <h3 class="text-base font-black text-gray-900 dark:text-white leading-tight">Rp {{ number_format($kpiStats['revIni'], 0, ',', '.') }}</h3>
        ...
        <div class="kpi-card bg-gradient-to-br from-white to-gray-50/50 dark:from-[#1E293B] dark:to-[#0F172A] border border-gray-100 dark:border-gray-800 rounded-xl p-3.5 shadow-sm flex flex-col justify-between">
            <div class="flex justify-between items-start mb-1">
                ...
                <div class="p-1 rounded-lg bg-amber-500/10 text-amber-600 dark:text-amber-400">
            ...
            <div>
                <h3 class="text-base font-black text-gray-900 dark:text-white leading-tight">Rp {{ number_format($kpiStats['expIni'], 0, ',', '.') }}</h3>
                <div class="mt-1.5 flex items-center gap-1">
        ...
        <div class="kpi-card bg-gradient-to-br from-white to-gray-50/50 dark:from-[#1E293B] dark:to-[#0F172A] border border-gray-100 dark:border-gray-800 rounded-xl p-3.5 shadow-sm flex flex-col justify-between">
            ...
            <div>
                <h3 class="text-base font-black text-gray-900 dark:text-white leading-tight">Rp {{ number_format($kpiStats['labaIni'], 0, ',', '.') }}</h3>
                <div class="mt-1.5 flex items-center gap-1">
        ...
        <div class="kpi-card bg-gradient-to-br from-white to-gray-50/50 dark:from-[#1E293B] dark:to-[#0F172A] border border-gray-100 dark:border-gray-800 rounded-xl p-3.5 shadow-sm flex flex-col justify-between">
            ...
            <div>
                <h3 class="text-base font-black text-gray-900 dark:text-white leading-tight">Rp {{ number_format($kpiStats['avgRevIni'], 0, ',', '.') }}</h3>
                <div class="mt-1.5 flex items-center gap-1">
        ...
        <div class="kpi-card bg-gradient-to-br from-white to-gray-50/50 dark:from-[#1E293B] dark:to-[#0F172A] border border-gray-100 dark:border-gray-800 rounded-xl p-3.5 shadow-sm flex flex-col justify-between">
            <div class="flex justify-between items-start mb-1">
                ...
                <div class="p-1 rounded-lg bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11 3.055A9.003 9.003 0 1020.945 13H11V3.055z"/></svg>
                </div>
            </div>
            <div>
                <h3 class="text-base font-black text-gray-900 dark:text-white leading-tight">{{ number_format($kpiStats['marginIni'], 1) }}%</h3>
                <div class="mt-1.5 flex items-center gap-1">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <!-- Area Chart: Tren -->
        <div class="lg:col-span-2 bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-gray-800 rounded-xl p-4 shadow-sm">
            <div class="mb-2">
                <h4 class="font-bold text-gray-900 dark:text-white text-sm">Tren Pendapatan 6 Bulan Terakhir</h4>
                <p class="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mt-0.5">Analisis Fluktuasi Jasa Tindakan Medis & Penjualan Obat</p>
            </div>
            <div id="chartKeuangan" class="w-full h-[280px]"></div>
        </div>

        <!-- Donut Chart: Proporsi Pendapatan -->
        <div class="bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-gray-800 rounded-xl p-4 shadow-sm flex flex-col justify-between">
            <div class="mb-2">
                <h4 class="font-bold text-gray-900 dark:text-white text-sm">Proporsi Arus Pendapatan</h4>
                <p class="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mt-0.5">Kontribusi Jasa Dokter vs Penjualan Obat Bulan Ini</p>
            </div>
            <div class="flex-grow flex items-center justify-center">
                <div id="chartDonutPengeluaran" class="w-full h-[220px]"></div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-gray-800 rounded-xl p-4 shadow-sm">
            <div class="flex justify-between items-center mb-3">
                <div>
                    <h4 class="font-bold text-gray-900 dark:text-white text-sm">Kontribusi Jasa Dokter</h4>
                    <p class="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mt-0.5">Akumulasi Jasa Medis & Konsultasi Berdasarkan Dokter</p>
                </div>
                <span class="text-[9px] bg-teal-500/10 text-teal-600 dark:text-teal-400 font-black uppercase tracking-widest px-2.5 py-1 rounded-full">Top Performer</span>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-800">
                    <thead class="bg-gray-50/50 dark:bg-gray-800/40">
                        <tr>
                            <th class="px-4 py-2 text-left text-[9px] font-black text-gray-400 uppercase tracking-widest">Nama Dokter</th>
                            <th class="px-4 py-2 text-center text-[9px] font-black text-gray-400 uppercase tracking-widest">Total Layanan</th>
                            <th class="px-4 py-2 text-right text-[9px] font-black text-gray-400 uppercase tracking-widest">Total Kontribusi (Rp)</th>
                        </tr>
                    </thead>
                        ...
                        <tr class="hover:bg-gray-50/30 dark:hover:bg-gray-800/10 transition-colors">
                            <td class="px-4 py-2.5 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    <div class="w-7 h-7 rounded-lg bg-teal-500/10 text-teal-600 flex items-center justify-center font-black text-xs" x-text="'0' + ({{ $idx }} + 1)"></div>
                                    <span class="text-xs font-bold text-gray-900 dark:text-white">{{ $doc->name ?: 'Tidak Diketahui' }}</span>
                                </div>
                            </td>
                            <td class="px-4 py-2.5 text-center whitespace-nowrap text-xs font-bold text-gray-500 dark:text-gray-400">
                                {{ $doc->total_prescriptions }} Transaksi
                            </td>
                            <td class="px-4 py-2.5 text-right whitespace-nowrap text-xs font-black text-teal-600">
                                Rp {{ number_format($doc->total_revenue, 0, ',', '.') }}
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="3" class="px-4 py-2.5 text-center text-xs font-bold text-gray-400 uppercase tracking-widest">Belum ada kontribusi resep dokter</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-gray-800 rounded-xl p-4 shadow-sm flex flex-col justify-between">
            <div>
                <div class="mb-3">
                    <h4 class="font-bold text-gray-900 dark:text-white text-sm">Kinerja Kategori Layanan</h4>
                    <p class="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mt-0.5">Analisis Kontribusi Omzet Bulan Ini</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-gray-800 rounded-xl p-4 shadow-sm">
            <div class="mb-2">
                <h4 class="font-bold text-gray-900 dark:text-white text-sm">Ikhtisar Bulanan Tabular</h4>
                <p class="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mt-0.5">Ringkasan Riwayat Performa Profitabilitas Tiap Bulan</p>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-800">
                    <thead class="bg-gray-50/50 dark:bg-gray-800/40">
                        <tr>
                            <th class="px-4 py-2 text-left text-[9px] font-black text-gray-400 uppercase tracking-widest">Bulan</th>
                            <th class="px-4 py-2 text-right text-[9px] font-black text-gray-400 uppercase tracking-widest">Jasa Dokter</th>
                            <th class="px-4 py-2 text-right text-[9px] font-black text-gray-400 uppercase tracking-widest">Penjualan Obat</th>
                            <th class="px-4 py-2 text-right text-[9px] font-black text-gray-400 uppercase tracking-widest">Total Omzet</th>
                            <th class="px-4 py-2 text-center text-[9px] font-black text-gray-400 uppercase tracking-widest">Porsi Dokter</th>
                            <th class="px-4 py-2 text-center text-[9px] font-black text-gray-400 uppercase tracking-widest">Status</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @foreach($summaryTable as $row)
                        <tr class="hover:bg-gray-50/30 dark:hover:bg-gray-800/10 transition-colors">
                            <td class="px-4 py-2.5 whitespace-nowrap text-xs font-bold text-gray-900 dark:text-white">{{ $row['month'] }}</td>
                            <td class="px-4 py-2.5 text-right whitespace-nowrap text-xs font-semibold text-gray-700 dark:text-gray-300">Rp {{ number_format($row['jasa_dokter'], 0, ',', '.') }}</td>
                            <td class="px-4 py-2.5 text-right whitespace-nowrap text-xs font-semibold text-gray-500 dark:text-gray-400">Rp {{ number_format($row['obat_sales'], 0, ',', '.') }}</td>
                            <td class="px-4 py-2.5 text-right whitespace-nowrap text-xs font-black text-teal-600">
                                Rp {{ number_format($row['total'], 0, ',', '.') }}
                            </td>
                            <td class="px-4 py-2.5 text-center whitespace-nowrap text-xs font-bold text-gray-600 dark:text-gray-300">{{ number_format($row['margin'], 1) }}%</td>
                            <td class="px-4 py-2.5 text-center whitespace-nowrap">
                                <span class="px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">
                                    Stabil
                                </span>
                            </td>
                        </tr>
        ...
        <div class="lg:col-span-1 space-y-4">
            ...
            @php
                ...
                $healthScore = 100;
            @endphp
            <div class="bg-gradient-to-br from-white to-gray-50/50 dark:from-[#1E293B] dark:to-[#0F172A] border border-gray-100 dark:border-gray-800 rounded-xl p-4 shadow-sm relative overflow-hidden group">
                <div class="absolute -right-6 -top-6 w-14 h-14 bg-teal-500/5 dark:bg-teal-500/10 rounded-full blur-xl group-hover:scale-150 transition-transform duration-700"></div>
                
                <h4 class="font-bold text-gray-900 dark:text-white mb-1 flex items-center gap-1.5 text-sm">
                    <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                    Indikator Finansial
                </h4>
                <p class="text-[9px] text-gray-400 font-bold uppercase tracking-wider mb-3">Real-time Financial Audit Insights</p>
                ...
                <div class="space-y-3">
                    ...
                    <div class="p-2.5 bg-teal-50/50 border border-teal-100 dark:bg-teal-950/20 dark:border-teal-900/30 rounded-lg">
                        <span class="text-[9px] font-black uppercase text-teal-600 tracking-wider block mb-0.5">Status Keuangan</span>
                        <p class="text-[11px] font-bold text-gray-700 dark:text-gray-300 leading-normal">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50/50 dark:from-[#1E293B] dark:to-[#0F172A] border border-gray-100 dark:border-gray-800 rounded-xl p-4 shadow-sm space-y-3">
                <div class="flex items-center gap-2.5">
                    <div class="w-8 h-8 rounded-lg bg-teal-600 text-white flex items-center justify-center shadow-lg shadow-teal-500/20">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                    </div>
                    <div>
                        <h4 class="font-bold text-gray-900 dark:text-white leading-none text-xs">Automated Invoice</h4>
                        <p class="text-[8px] text-gray-400 font-bold uppercase tracking-wider mt-0.5">Sistem Keuangan Otomatis</p>
                    </div>
                </div>
                <div class="p-3 bg-teal-50/30 dark:bg-teal-950/10 border border-teal-100/50 dark:border-teal-900/30 rounded-xl text-[10px] font-bold text-gray-600 dark:text-gray-300 leading-relaxed space-y-1">
                    <p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-gray-800 rounded-xl p-4 shadow-sm">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
                <div>
                    <h4 class="font-bold text-gray-900 dark:text-white text-sm">Daftar Histori Pengeluaran</h4>
                    <p class="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mt-0.5">Catatan Log Biaya Operasional Klinik</p>
                </div>
                <div class="flex items-center gap-2 w-full sm:w-auto">
                    <input type="text" id="searchPengeluaran" placeholder="Cari log..." class="bg-gray-50 dark:bg-[#0F172A] border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-1.5 text-xs font-semibold focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none transition-all dark:text-white w-full sm:w-40" oninput="filterPengeluaranTable()">
                    <button onclick="exportPengeluaranToCSV()" class="bg-teal-50 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400 border border-teal-100 dark:border-teal-900 hover:bg-teal-100 px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-wider transition-all flex items-center gap-1 whitespace-nowrap shadow-sm" title="Ekspor data ke CSV">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-800">
                    <thead class="bg-gray-50/50 dark:bg-gray-800/40">
                        <tr>
                            <th class="px-4 py-2 text-left text-[9px] font-black text-gray-400 uppercase tracking-widest">Tanggal</th>
                            <th class="px-4 py-2 text-left text-[9px] font-black text-gray-400 uppercase tracking-widest">No. Resep & Pasien</th>
                            <th class="px-4 py-2 text-right text-[9px] font-black text-gray-400 uppercase tracking-widest">Jasa Dokter</th>
                            <th class="px-4 py-2 text-right text-[9px] font-black text-gray-400 uppercase tracking-widest">Penjualan Obat</th>
                            <th class="px-4 py-2 text-right text-[9px] font-black text-gray-400 uppercase tracking-widest">Total Omzet</th>
                        </tr>
                    ...
                    <tbody id="pengeluaranTableBody" class="divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        @endphp
                        <tr class="hover:bg-gray-50/30 dark:hover:bg-gray-800/10 transition-colors">
                            <td class="px-4 py-2.5 whitespace-nowrap text-xs font-bold text-gray-500 dark:text-gray-400">{{ $item->tanggal_resep->format('d M Y') }}</td>
                            <td class="px-4 py-2.5">
                                <div class="pengeluaran-desc text-xs font-bold text-gray-900 dark:text-white leading-none">{{ $item->nama_pasien }}</div>
                                <span class="pengeluaran-cat text-[8px] bg-teal-500/10 text-teal-600 dark:text-teal-400 font-black uppercase tracking-wider px-2 py-0.5 rounded-full inline-block mt-1">{{ $item->no_resep }}</span>
                            </td>
                            <td class="px-4 py-2.5 text-right whitespace-nowrap text-xs text-gray-600 dark:text-gray-300 font-semibold">
                                Rp {{ number_format($item->biaya_dokter, 0, ',', '.') }}
                            </td>
                            <td class="px-4 py-2.5 text-right whitespace-nowrap text-xs text-gray-600 dark:text-gray-300 font-semibold">
                                Rp {{ number_format($obatTotal, 0, ',', '.') }}
                            </td>
                            <td class="px-4 py-2.5 text-right whitespace-nowrap text-xs text-teal-600 font-black">
                                Rp {{ number_format($item->biaya_dokter + $obatTotal, 0, ',', '.') }}
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="5" class="px-4 py-2.5 text-center text-xs font-bold text-gray-400 uppercase tracking-widest">Belum ada data pendapatan</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <!-- Top 5 Obat Terlaris -->
        <div class="lg:col-span-1 bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-gray-800 rounded-xl p-4 shadow-sm">
            <div class="mb-2 flex justify-between items-center">
                <div>
                    <h4 class="font-bold text-gray-900 dark:text-white text-sm">Top 5 Obat</h4>
                    <p class="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mt-0.5">Penyumbang Omzet Apotek Tertinggi</p>
                </div>
            </div>
            <div class="space-y-2">
                @forelse($topMedicines as $idx => $med)
                <div class="flex items-center justify-between gap-2.5 p-2.5 rounded-lg hover:bg-gray-50/50 dark:hover:bg-gray-800/10 transition-all border border-gray-50 dark:border-gray-800">
                    <div class="flex items-center gap-2 min-w-0">
                        <div class="w-5.5 h-5.5 rounded-lg bg-teal-500/10 text-teal-600 flex items-center justify-center font-black text-[10px]" x-text="'0' + ({{ $idx }} + 1)"></div>
                        <div class="min-w-0">
