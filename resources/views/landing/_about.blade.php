{{-- Tentang Kami --}}
<section id="tentang" class="py-24 px-6 md:px-16" style="background: linear-gradient(180deg, #FAFFFE 0%, #F0FDF4 100%);">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="scroll-reveal-left">
            ...
            <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 mt-4 mb-6">Dedikasi Penuh untuk<br>Kesehatan Keluarga</h2>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0" style="background: rgba(13,148,136,0.1);">
                ...
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0" style="background: rgba(6,182,212,0.1);">
                ...
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0" style="background: rgba(139,92,246,0.1);">
        ...
        {{-- Right: Decorative --}}
        <div class="scroll-reveal-right hidden lg:block">
            <div class="relative">
