{{-- ====================================================
     LANDMARK SEMANTIK: <section> dengan aria-labelledby
     menghubungkan section ke heading-nya. Screen Reader
     akan mengumumkan "bagian: Layanan Kesehatan Terpercaya"
     saat pengguna menavigasi antar landmark.

     WCAG 1.3.1 (Info and Relationships) &
     WCAG 2.4.6 (Headings and Labels) terpenuhi.
     ==================================================== --}}
<section class="hero-section" id="beranda" aria-labelledby="hero-heading">

    {{-- Partikel animasi murni dekoratif — Screen Reader harus diabaikan --}}
    ...
    {{-- Canvas boids — murni animasi dekoratif --}}
    <canvas id="boids-canvas" aria-hidden="true"></canvas>

    {{-- Ring dekoratif — tidak bermakna secara konten --}}
    ...
    <div class="hero-content relative z-10 w-full px-6 md:px-16 lg:px-24 py-20 max-w-7xl mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {{-- Kolom teks utama --}}
            <div>
                {{-- Badge dekoratif — duplikat informasi dari heading, cukup disembunyikan --}}
                <div class="section-badge mb-6 animate-fade-in-up" aria-hidden="true">
                ...
                {{-- WCAG 1.3.1 & 2.4.6: Satu <h1> unik per halaman.
                     id="hero-heading" digunakan oleh aria-labelledby pada <section>. --}}
                <h1 id="hero-heading"
                    class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6 animate-fade-in-up delay-100"
                    style="text-shadow: 0 2px 30px rgba(0,0,0,0.15);">
                    Layanan<br>Kesehatan<br>
                    {{-- Gradien teks visual — konten tetap terbaca oleh AT karena ada dalam elemen teks --}}
                    <span style="background: linear-gradient(90deg, #A7F3D0, #67E8F9); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                        Terpercaya
                    </span>
                </h1>
            ...
            {{-- Kartu dekoratif kanan — purely presentational.
                 aria-hidden="true" pada seluruh div mencegah Screen Reader
                 membaca data dummy yang bisa membingungkan pengguna. --}}
            <div class="hidden lg:flex justify-center animate-fade-in-up delay-400"
                 style="opacity:0;"
                 aria-hidden="true">
